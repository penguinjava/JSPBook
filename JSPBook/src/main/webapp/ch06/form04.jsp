...
<body>
	<form action="form04_process.jsp" name="member" method="post">
		...
		<p> 성 별 : <input type="radio" name="sex" value="man"/>남성
					<input type="radio" name="sex" value="woman"/>여성
		<p> 취 미 : 독서<input type="checkbox" name="hobby1"/>
			운 동<input type="checkbox" name="hobby2"/>
			영 화<input type="checkbox" name="hobby3"/>
